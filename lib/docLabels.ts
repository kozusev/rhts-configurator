...
const D: Record<string, Record<string, string>> = {
  ...
  taxId: { en: "Tax ID", es: "NIF/CIF" },
  description: { en: "Description", es: "Descripción" },
  qty: { en: "Qty", es: "Cant." },
  unit: { en: "Unit", es: "Unitario" },
  amount: { en: "Amount", es: "Importe" },
  netTotal: { en: "Net total", es: "Total neto" },
  vat: { en: "VAT", es: "IVA" },
  totalDue: { en: "Total due", es: "Total a pagar" },
  paymentTerms: { en: "Payment terms", es: "Condiciones de pago" },
  paymentDetails: { en: "Payment details", es: "Datos de pago" },
  generalTerms: { en: "General Terms and Conditions", es: "Términos y condiciones generales" },
  hsCode: { en: "HS code", es: "Código HS" },
  beneficiary: { en: "Beneficiary", es: "Beneficiario" },
  iban: { en: "IBAN", es: "IBAN" },
  swiftBic: { en: "SWIFT / BIC", es: "SWIFT / BIC" },
  intermediaryBic: { en: "Intermediary BIC", es: "BIC intermediario" },
  beneficiaryAddress: { en: "Beneficiary address", es: "Dirección del beneficiario" },
  bankName: { en: "Bank / Payment institution", es: "Banco / Entidad de pago" },
  bankAddress: { en: "Bank address", es: "Dirección del banco" },
